...
public class SortedDescendingOrderDemo {
	...
	public static void main(String[] args) {
		...
		Stream<Integer> sortedStream  = fileterdStream.sorted((i1, i2) -> i2.compareTo(i1));
		sortedStream.forEach(x -> System.out.println(x));
		
		System.out.println("Now in single line");
		
		Stream<Integer> newFileterdSortedList = arList.stream().sorted((i1, i2) -> i2.compareTo(i1));
